...
}(this, function (moment)
{
    ...
    {
      var headerT = '<tr>'+
      (opts.timeLabel !== null ? '<td></td>' : '') +
      (opts.showTime !== null && opts.showTime? '<td style="color: #999;font-size: 12px;font-weight: bold;text-align: center;"><span style="">Hours</span></td>' : '') +
      (opts.showMinutes !== null && opts.showMinutes? '<td>:</td><td style="color: #999;font-size: 12px;font-weight: bold;text-align: center;"><span>Minuets</span></td>' : '') +
      (opts.showSeconds !== null &&  opts.showSeconds ? '<td>:</td><td style="color: #999;font-size: 12px;font-weight: bold;text-align: center;"><span>Seconds</span></td>' : '') +
      '</tr>';

        var to_return = '<table cellpadding="0" cellspacing="0" class="pika-time"><tbody>'+
        (opts.showTime !== null && opts.showTime ? headerT : '') +
        '<tr>' +
    ...
    Pikaday.prototype = {
        ...
        setDate: function(date, preventOnSelect)
        {
            ...
            if (this._o.field) {
                ...
                // David added to fix angular ngModel change event
