...
// import {ObjectUtils} from 'primeng/primeng';
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        <span  class="ui-cell-data" *ngIf="!col.bodyTemplate && !col.expander && !col.selectionMode"
                               [title]="dt.resolveFieldData(rowData,col.field)">
                          <span #ss [ngClass]="dt.ellipsis ? 'ui-ellipsis' : ''" >{{dt.resolveFieldData(rowData,col.field)}}</span>

                          <div [hidden]="!isEllipsisActive(ss)" class="ui-datatable-tooltip ui-tooltip-bottom">
